...
const Otplogin = ({setAuthenticated}) => {
    ...
    return (
        <div className='loginModule d-flex justify-content-center align-items-center 100-w vh-100 '>
            <div className='form_container otp p-5 rounded bg-white'>
                ...
                <form onSubmit={onSignInSubmit}>
                    ...
                    />
                    <button type="submit" className='form-control my-2' id='mobilelogin'>Submit</button>
                </form>
                ...
                {isActive && (
                    <form onSubmit={onSubmitOTP}>
                        ...
                        <input
                            ...
                            onChange={handleChange}
                        />
                        <button type="submit" className='form-control my-2' id='otpverify'>Verify</button>
                        <p>If you didn't receive a code !!! <b>RESEND</b></p>
                    </form>
                )}
            </div>
        </div>
